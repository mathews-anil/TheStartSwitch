...
const AboutMathews = () => {
    return (
        <section className='max-w-[1300px] mt-3 md:mt-0 mx-auto px-[15px] md:px-6 py-[26px] md:py-[99px] flex flex-col lg:flex-row gap-[30px] w-full items-center justify-between pt-[40px]' id='about'>
