...
const AboutMathews = () => {
    return (
        <section className='max-w-[1300px] mt-[26px] md:mt-0 mx-auto px-[15px] md:px-6 py-[26px] md:py-[99px] flex flex-col lg:flex-row gap-[30px] w-full items-center justify-between pt-[40px]' id='about'>
            ...
            <div className='flex flex-col gap-[21px] md:gap-[31px] w-full lg:w-[620px]'>
                ...
                <Link href="https://www.anilmathews.com/" target='_blank' >
